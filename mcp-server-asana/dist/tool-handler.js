...
export const tools = {
    ...
    asana_list_workspace_users: {
        ...
        inputSchema: z.object({
            workspace_id: z
                .string()
                .optional()
                .describe('The workspace ID to list users from (optional if DEFAULT_WORKSPACE_ID is set)'),
            limit: z
                .number()
                .min(1)
                .max(100)
    ...
    asana_get_user: {
        name: 'asana_get_user',
        description: 'Get information about a specific user. Use "me" to get current user.',
        inputSchema: z.object({
            user_id: z
                .string()
