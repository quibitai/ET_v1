...
export const tools = {
    ...
    asana_search_tasks: {
        ...
        inputSchema: z.object({
            workspace: z
                .string()
                .optional()
                .describe('The workspace to search in (optional if DEFAULT_WORKSPACE_ID is set)'),
            text: z
                .string()
                .optional()
    ...
    asana_set_parent_for_task: {
        ...
        inputSchema: z.object({
            ...
            insert_after: z
                .string()
                .optional()
                .describe('A subtask of the parent to insert the task after, or null to insert at the beginning'),
            insert_before: z
                .string()
                .optional()
                .describe('A subtask of the parent to insert the task before, or null to insert at the end'),
            opt_fields: z
                .string()
                .optional()
                .describe('Comma-separated list of optional fields to include'),
    ...
    asana_get_multiple_tasks_by_gid: {
        ...
        inputSchema: z.object({
            task_ids: z
                ...
                .describe('Task GIDs to retrieve (max 25) - can be array or comma-separated string'),
            opt_fields: z
                .string()
                .optional()
                .describe('Comma-separated list of optional fields to include'),
    ...
    asana_list_projects: {
        ...
        inputSchema: z.object({
            workspace: z
                .string()
                .optional()
                .describe('The workspace to list projects from (optional if DEFAULT_WORKSPACE_ID is set)'),
            team: z.string().optional().describe('The team to filter projects on'),
            archived: z
                .boolean()
                .optional()
    ...
    asana_create_project: {
        ...
        inputSchema: z.object({
            workspace_id: z
                .string()
                .optional()
                .describe('The workspace ID to create the project in (optional if DEFAULT_WORKSPACE_ID is set)'),
            name: z.string().describe('Name of the project to create'),
            team_id: z
                .string()
                .describe('REQUIRED for organization workspaces - The team GID to share the project with'),
            public: z
                .boolean()
                .optional()
                .describe('Whether the project is public to the organization (default: false)'),
            archived: z
                .boolean()
                .optional()
            ...
            color: z
                .string()
                .optional()
                .describe('Color of the project (light-green, light-orange, light-blue, etc.)'),
            layout: z
                .string()
                .optional()
                .describe('The layout of the project (board, list, timeline, or calendar)'),
            default_view: z
                .string()
                .optional()
                .describe('The default view of the project (list, board, calendar, timeline, or gantt)'),
            due_on: z
                .string()
                .optional()
            ...
            start_on: z
                .string()
                .optional()
                .describe('The day on which work for this project begins (YYYY-MM-DD format)'),
            notes: z
                .string()
                .optional()
    ...
    asana_get_project_hierarchy: {
        ...
        description: 'Get the complete hierarchical structure of an Asana project, including sections, tasks, and subtasks',
        inputSchema: z.object({
            ...
            include_completed_subtasks: z
                .boolean()
                .optional()
                .describe('Include completed subtasks (default: follows include_completed_tasks)'),
            max_subtask_depth: z
                .number()
                .optional()
    ...
    asana_get_teams_for_user: {
        ...
        inputSchema: z.object({
            user_gid: z
                .string()
                .describe('The user GID to get teams for. Use "me" to get teams for the current user.'),
            opt_fields: z
                .string()
                .optional()
                .describe('Comma-separated list of optional fields to include'),
    ...
    asana_get_teams_for_workspace: {
        ...
        inputSchema: z.object({
            workspace_gid: z
                .string()
                .optional()
                .describe('The workspace GID to get teams for (optional if DEFAULT_WORKSPACE_ID is set)'),
            opt_fields: z
                .string()
                .optional()
                .describe('Comma-separated list of optional fields to include'),
    ...
    asana_list_workspace_users: {
        ...
        inputSchema: z.object({
            workspace_id: z
                .string()
                .optional()
                .describe('The workspace ID to get users for (optional if DEFAULT_WORKSPACE_ID is set)'),
            limit: z
                .number()
                .min(1)
                .max(100)
            ...
            opt_fields: z
                .string()
                .optional()
                .describe('Comma-separated list of optional fields to include (defaults to "name,email")'),
            auto_paginate: z
                .boolean()
                .optional()
                .describe('Whether to automatically fetch all pages'),
            max_pages: z
                .number()
                .optional()
                .describe('Maximum number of pages to fetch when auto_paginate is true'),
        }),
    },
    // Tag tools
    asana_get_tags_for_workspace: {
        ...
        inputSchema: z.object({
            workspace_gid: z
                .string()
                .optional()
                .describe('Globally unique identifier for the workspace or organization (optional if DEFAULT_WORKSPACE_ID is set)'),
            limit: z
                .number()
                .min(1)
                .max(100)
            ...
            offset: z
                .string()
                .optional()
                .describe('Offset token. An offset to the next page returned by the API.'),
            opt_fields: z
                .string()
                .optional()
                .describe('Comma-separated list of optional fields to include'),
    ...
    asana_get_tasks_for_tag: {
        ...
        inputSchema: z.object({
            ...
            limit: z
                ...
                .max(100)
                .optional()
                .describe('The number of objects to return per page. The value must be between 1 and 100.'),
            offset: z
                .string()
                .optional()
        ...
        try {
            ...
            switch (name) {
                ...
                case 'asana_add_task_dependencies':
                    return await client.addTaskDependencies(args.task_id, args.dependencies);
                ...
                case 'asana_get_project_task_counts':
                    return await client.getProjectTaskCounts(args.project_id, args.opt_fields);
                case 'asana_get_project_sections':
                    return await client.getProjectSections(args.project_id, args.opt_fields);
                ...
                case 'asana_get_project_status':
                    return await client.getProjectStatus(args.project_status_gid, args.opt_fields);
                ...
                case 'asana_create_project_status': {
                    ...
                    return await client.createProjectStatus(statusProjectGid, createStatusParams);
                }
                ...
                case 'asana_create_section_for_project': {
                    ...
                    return await client.createSectionForProject(sectionProjectId, sectionParams);
                }
                case 'asana_add_task_to_section':
                    return await client.addTaskToSection(args.section_id, args.task_id, args.opt_fields);
                // Team and user tools
                ...
                case 'asana_get_teams_for_workspace':
                    return await client.getTeamsForWorkspace(args.workspace_gid, args.opt_fields);
                ...
                case 'asana_get_attachments_for_object': {
                    ...
                    return await client.getAttachmentsForObject(object_gid, attachmentParams);
                }
                default:
