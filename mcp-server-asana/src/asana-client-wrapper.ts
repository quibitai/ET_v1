...
export class AsanaClientWrapper {
  ...
  private async withErrorHandling<T>(
    ...
    try {
      ...
      if (error.response?.body) {
        ...
        throw new Error(
          `Asana API Error in ${operationName}: ${apiError.errors?.[0]?.message || apiError.message || 'Unknown error'}`,
        );
      }
  ...
  async listWorkspaces(optFields?: string): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.defaultWorkspaceId) {
        ...
        const workspace = await workspacesApi.getWorkspace(
  ...
  async getTask(taskId: string, optFields?: string): Promise<any> {
    return this.withErrorHandling(async () => {
      // @ts-ignore - Type definitions don't match runtime structure
      const tasksApi = new Asana.TasksApi();
  ...
  async createTask(params: any): Promise<any> {
    return this.withErrorHandling(async () => {
      ...
      const result = await tasksApi.createTask(
        body,
        params.opt_fields ? { opt_fields: params.opt_fields } : {},
      );
      return result.data;
    }, 'createTask');
  }

  async updateTask(taskId: string, params: any): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
  ...
  async getTaskStories(taskId: string, optFields?: string): Promise<any> {
    return this.withErrorHandling(async () => {
      // @ts-ignore - Type definitions don't match runtime structure
  ...
  async createTaskStory(taskId: string, params: any): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
  ...
  async createSubtask(parentTaskId: string, params: any): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
      ...
      const tasksApi = new Asana.TasksApi();
      const body = { data: params };
      const result = await tasksApi.createSubtaskForTask(
        body,
        parentTaskId,
        params.opt_fields ? { opt_fields: params.opt_fields } : {},
      );
  ...
  async addTaskDependencies(
    ...
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
        throw new Error(
          'Task dependency updates are disabled in read-only mode',
        );
      }
  ...
  async addTaskDependents(taskId: string, dependents: string[]): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
        throw new Error(
          'Task dependent updates are disabled in read-only mode',
        );
      }
  ...
  async addFollowersToTask(taskId: string, followers: string[]): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
  ...
  async setParentForTask(taskId: string, params: any): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
      ...
      const tasksApi = new Asana.TasksApi();
      const body = { data: params };
      const result = await tasksApi.setParentForTask(
        body,
        taskId,
        params.opt_fields ? { opt_fields: params.opt_fields } : {},
      );
  ...
  async listProjects(params: any = {}): Promise<any> {
    return this.withErrorHandling(async () => {
      ...
      if (params.team) {
        ...
        const result = await projectsApi.getProjectsForWorkspace(
          workspace,
          queryParams,
        );
        return result.data;
  ...
  async getProject(projectId: string, optFields?: string): Promise<any> {
    return this.withErrorHandling(async () => {
      // @ts-ignore - Type definitions don't match runtime structure
      const projectsApi = new Asana.ProjectsApi();
  ...
  async createProjectStatus(projectId: string, params: any): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
        throw new Error(
          'Project status creation is disabled in read-only mode',
        );
      }
      ...
      const body = { data: params };
      const result = await projectStatusesApi.createProjectStatusForProject(
        body,
        projectId,
        params.opt_fields ? { opt_fields: params.opt_fields } : {},
      );
  ...
  async getProjectStatuses(projectId: string, params: any = {}): Promise<any> {
    return this.withErrorHandling(async () => {
      // @ts-ignore - Type definitions don't match runtime structure
      const projectStatusesApi = new Asana.ProjectStatusesApi();
  ...
  async getProjectStatus(
    ...
    return this.withErrorHandling(async () => {
      // @ts-ignore - Type definitions don't match runtime structure
      const projectStatusesApi = new Asana.ProjectStatusesApi();
      const result = await projectStatusesApi.getProjectStatus(
        projectStatusId,
        { opt_fields: optFields },
      );
      return result.data;
  ...
  async deleteProjectStatus(projectStatusId: string): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
        throw new Error(
          'Project status deletion is disabled in read-only mode',
        );
      }
      ...
      const projectStatusesApi = new Asana.ProjectStatusesApi();
      const result =
        await projectStatusesApi.deleteProjectStatus(projectStatusId);
      return result.data;
    }, 'deleteProjectStatus');
  }

  async createSectionForProject(projectId: string, params: any): Promise<any> {
    return this.withErrorHandling(async () => {
      if (this.config.readOnlyMode) {
      ...
      const sectionsApi = new Asana.SectionsApi();
      const body = { data: params };
      const result = await sectionsApi.createSectionForProject(
        body,
        projectId,
        params.opt_fields ? { opt_fields: params.opt_fields } : {},
      );
  ...
  async addTaskToSection(
    ...
    return this.withErrorHandling(async () => {
      ...
      const result = await sectionsApi.addTaskForSection(
        body,
        sectionId,
  ...
  // Team operations
  async getTeamsForUser(userGid: string, optFields?: string): Promise<any> {
    return this.withErrorHandling(async () => {
      // @ts-ignore - Type definitions don't match runtime structure
  ...
  async getTasksForTag(tagGid: string, params: any = {}): Promise<any> {
    return this.withErrorHandling(async () => {
      // @ts-ignore - Type definitions don't match runtime structure
      const tagsApi = new Asana.TagsApi();
  ...
  async getMultipleTasksByGid(
    ...
    return this.withErrorHandling(async () => {
      ...
      const tasks = await Promise.all(
        taskIds.map((taskId) =>
          tasksApi.getTask(taskId, { opt_fields: optFields }),
        ),
      );
      return tasks.map((task: any) => task.data);
    }, 'getMultipleTasksByGid');
  }

  async getProjectHierarchy(projectId: string, params: any = {}): Promise<any> {
    return this.withErrorHandling(async () => {
      // @ts-ignore - Type definitions don't match runtime structure
      const projectsApi = new Asana.ProjectsApi();
      // @ts-ignore - Type definitions don't match runtime structure
